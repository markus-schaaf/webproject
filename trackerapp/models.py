...
class DailyFood(models.Model):
    ...
    fat_eaten = models.PositiveIntegerField(default=0) 
    carbohydrates_eaten = models.PositiveIntegerField(default=0)
    protein_eaten = models.PositiveIntegerField(default=0)  
